...
public class ReadRssHolofote extends AsyncTask<Void, Void, Void> {
    Context context;
    String address = "https://www.bahianoticias.com.br/holofote/rss.xml";
    ...
    public ReadRssHolofote(Context context, RecyclerView recyclerView) {
