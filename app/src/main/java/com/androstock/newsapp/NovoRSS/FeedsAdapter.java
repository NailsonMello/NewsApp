...
import com.androstock.newsapp.MostrarNoticias;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, MostrarNoticias.class);
                intent.putExtra("titulo",current.getTitle());
                intent.putExtra("desc",current.getDescription());
                intent.putExtra("data",current.getPubDate());
                intent.putExtra("imagem",current.getThumbnailUrl());
