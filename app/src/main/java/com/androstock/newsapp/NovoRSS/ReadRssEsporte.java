...
public class ReadRssEsporte extends AsyncTask<Void, Void, Void> {
    Context context;
    String address = "https://www.bahianoticias.com.br/esportes/rss.xml";
    ...
    public ReadRssEsporte(Context context, RecyclerView recyclerView) {
