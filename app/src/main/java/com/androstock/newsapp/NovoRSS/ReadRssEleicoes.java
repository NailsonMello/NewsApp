...
public class ReadRssEleicoes extends AsyncTask<Void, Void, Void> {
    Context context;
    String address = "https://www.infomoney.com.br/ultimas-noticias/rss";
    ...
    public ReadRssEleicoes(Context context, RecyclerView recyclerView) {
            ...
            for (int i = 0; i < items.getLength(); i++) {
                ...
                if (cureentchild.getNodeName().equalsIgnoreCase("item")) {
                    ...
                    for (int j = 0; j < itemchilds.getLength(); j++) {
                        ...
                        } else if (cureent.getNodeName().equalsIgnoreCase("image-url")) {
