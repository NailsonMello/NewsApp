...
public class ReadRssSaude extends AsyncTask<Void, Void, Void> {
    Context context;
    String address = "https://www.bahianoticias.com.br/saude/rss.xml";
    ...
    public ReadRssSaude(Context context, RecyclerView recyclerView) {
