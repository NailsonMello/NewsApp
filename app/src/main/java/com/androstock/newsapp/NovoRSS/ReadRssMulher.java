...
public class ReadRssMulher extends AsyncTask<Void, Void, Void> {
    Context context;
    String address = "https://www.bahianoticias.com.br/mulheres/rss.xml";
    ...
    public ReadRssMulher(Context context, RecyclerView recyclerView) {
